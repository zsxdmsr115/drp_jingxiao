...
<%@page import="com.yc.drp.util.PageModel"%>
	...
	<form name="userform" id="userform">
		...
		<table width="95%" border="1" cellspacing="0" cellpadding="0"
			...
			<%
			  ...
			  %>
			  	<tr>
				<td width="55" class="rd8"><input type="checkbox" name="selectFlag"
					onClick="checkAll(this)" class="checkbox1" value="<%=user.getUserId() %>"></td>
				<td width="119" class="rd8"><%=user.getUserId() %></td>
				<td width="152" class="rd8"><%=user.getUserName() %></td>
				<td width="166" class="rd8"><%=user.getContactTel() %></td>
				<td width="150" class="rd8"><%=user.getEmail() %></td>
				<td width="153" class="rd8"><%=user.getCreateDate() %></td>
			</tr>
			  <% 
			  }
			%>
		...
		<table width="95%" height="30" border="0" align="center"
			...
			<tr>
				<td nowrap class="rd19" height="2">
					<div align="left">
						<font color="#FF0000">&nbsp;共&nbsp;<%=pageModel.getTotalPages() %>页</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<font color="#FF0000">当前第</font>&nbsp <font color="#FF0000"><%=pageModel.getPageNo() %></font>&nbsp
						<font color="#FF0000">页</font>
					</div>
				</td>
